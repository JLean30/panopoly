...
class ForumTest extends BrowserTestBase {
  ...
  public function testForum() {
    ...
    $elements = $this->xpath('//div[contains(@class, "field--name-taxonomy-forums")]//a[contains(@href, :href)]', [':href' => 'forum/' . $this->forum['tid']]);
    $this->assertEqual(count($elements), 1, 'Found taxonomy term overridden link.');
